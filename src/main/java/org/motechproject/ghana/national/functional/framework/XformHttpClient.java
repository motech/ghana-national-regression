...
public class XformHttpClient {
    ...
    public static StudyData getStudyData(String studyName, String[] xmlStrings) throws ParseException {
        ...
        for (String string : xmlStrings) {
            ...
            hackDate(formData, "/patientRegistration/lastPneumococcalDate");
            ...
            hackDate(formData, "/CWCRegistration/lastPneumococcalDate");
            ...
            hackDate(formData, "/careHistory/lastPneumococcalDate");
    ...
    private static void hackDateTime(FormData formData, String variableName) throws ParseException {
        ...
        final String answer = (String) question.getAnswer();
        if (answer == null) return;
        formData.setDateValue(variableName, new SimpleDateFormat("M/d/y H:m:s").parse(answer));
    }
