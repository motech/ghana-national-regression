...
public class ANCVisitFormUploadTest extends OpenMRSAwareFunctionalTest {
    ...
    private XformHttpClient.XformResponse createAncVisit(final String staffId, final String facilityId,
        ...
        return mobile.upload(MobileForm.ancVisitForm(), new HashMap<String, String>() {{
            ...
            put("date", new SimpleDateFormat("M/d/y").format(today().toDate()));
            put("estDeliveryDate", new SimpleDateFormat("M/d/y").format(updatedEDD.toDate()));
            ...
            put("referred", "Y");
            put("maleInvolved", "N");
            put("nextANCDate", new SimpleDateFormat("M/d/y").format(nextANCVisitDate.toDate()));
        }});
    }
    ...
    private String formatDate(LocalDate date) {
        return new SimpleDateFormat("M/d/y").format(date.toDate());
    }
}
